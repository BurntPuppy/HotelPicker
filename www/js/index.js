...
function get() {
    //get item from database and put inside variable
    var itemtoget = localStorage.getItem('name');
    //set value of textbox to what was gotten from the database
    //local storage in case of no internet connection
    $('#get').val(itemtoget);
}